...
description: A real-time 2D Lattice Boltzmann fluid simulation around a NACA aerofoil, showing how angle of attack and airspeed affect lift via flow visualisation.
---
...
|-----------|---------|-------------|
| `naca` | `2412` | NACA 4-digit profile code |
