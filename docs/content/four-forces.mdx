...
- **The glide** — close the throttle and lower the nose: the aircraft settles into a steady glide with lift still nearly equal to weight, tilted slightly forward, while the along-path component of weight does the job thrust used to do — the drag arrow and that weight component match exactly
