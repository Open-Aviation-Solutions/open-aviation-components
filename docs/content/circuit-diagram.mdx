...
Drag to orbit, scroll to zoom. Use the legend (top-left) to show or hide individual procedures so you can study one in isolation or overlay them for comparison.
...
Because a real circuit is kilometres wide but only a few hundred metres high, it would look almost flat at true scale. The `vertical-exaggeration` factor (default `4`) stretches the vertical axis so the climb gradients and pattern altitude read clearly — keep this in mind when judging heights by eye.
...
<circuit-diagram runway="27" vertical-exaggeration="4">
  <circuit-path
    ...
    color="#3b82f6cc"
    points="0,0,0; 1500,0,75; 2100,0,150; 2100,-850,300; -400,-850,300; -1100,-550,180; -1400,0,90; 0,0,0"
    segment-labels="0:Upwind; 2:Crosswind; 3:Downwind · 1000 ft; 4:Base; 5:Final"
  ></circuit-path>
</circuit-diagram>
```
