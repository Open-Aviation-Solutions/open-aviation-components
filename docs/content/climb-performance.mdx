...
| `vztp` | `3.3` | Prop zero-thrust speed (normalised). Tunes where Vy falls relative to Vmd: `3.3` places Vy ≈ Vmd (best glide), matching typical piston POH data. Use `3.6` for a Cessna 152/172 feel (Vy just above Vmd) or `3.0` for a Piper PA-28 feel (Vy just below Vmd) |
