...
| `vztp` | `2.7` | Prop zero-thrust speed (normalised). Tunes where Vy falls relative to Vmd: `2.7` places Vy ≈ Vmd (best glide), matching typical piston POH data. Use `3.0` for a Cessna 152/172 feel (Vy just above Vmd) or `2.5` for a Piper PA-28 feel (Vy just below Vmd) |
